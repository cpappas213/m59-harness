...
export const HARD_CAP_FALLBACK = 70;
...
export function healthCeiling(stamina) {
...
export function carryCapacity(might) {
...
export function statsKey(stats) {
...
export function statBars(stats, { caps = null, observed = true } = {}) {
...
export function statFoot(stats) {
...
export function statPane(stats, { caps = null, foot = true, extra = '' } = {}) {
