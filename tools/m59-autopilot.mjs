...
export const STRATEGIES = {
  // These are optional food experiments. Their eating behavior is used only after the
  // caller explicitly opts in with eat_before_fighting.
...
export class Autopilot {
  ...
  async provision(plan, v) {
    const p = this.policy;
    // Eating is an explicit caller decision. Inventory and strategy defaults never
    // grant permission to consume or manufacture food.
